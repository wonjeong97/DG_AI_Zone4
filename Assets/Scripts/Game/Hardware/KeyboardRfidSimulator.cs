...
namespace DGAIZone.Game.Hardware
{
    ...
    /// 1번 키는 "동작", 2번 키는 "제어", 3번 키는 "논리" 카테고리 카드를 찍은 것처럼 RfidTagEvent를 발행함.
    /// </summary>
    public class KeyboardRfidSimulator : MonoBehaviour
    {
        ...
        private static readonly string[] KeyCategories = { CategoryAction, CategoryControl, CategoryLogic };
        ...
        /// <summary> 매 프레임 1~3번 키 입력을 확인해 대응하는 카테고리 카드 인식을 발행함. </summary>
        private void Update()
        {
